                ...
                <div className="py-10 relative w-full flex flex-col h-full">
                  <div className="flex items-center justify-center gap-2">
                    <div className="relative w-full md:w-1/2 lg:w-1/3 xl:w-1/4">
                      <select
                        className="w-full cursor-pointer rounded-md border border-black/10 bg-white py-2 pl-3 pr-10 text-left focus:border-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-400 dark:border-white/20 dark:bg-gray-800 dark:text-white sm:text-sm" value={selectedModel.id}
                        onChange={(e) => {
                          // console.log(e.target.value);
                          const model = OPENAI_MODELS.find(model => model.id === e.target.value);
                          console.log(model);
                          setSelectedModel(model || DEFAULT_OPENAI_MODEL);
                          console.log(selectedModel);
                        }}
                      >
